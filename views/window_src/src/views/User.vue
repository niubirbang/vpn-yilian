...
import { USER_LEVEL_NORMAL, USER_LEVEL_FREE, USER_LEVEL_VIP, USER_LEVEL_SVIP, USER_LEVEL_FOREVER } from '@/store'
...
<template>
  <div class="large-full main-bg">
    ...
    <div class="l2 page-padding">
      <div
        class="x1 pointer vip"
        v-push="'/recharge?key=vip'"
      >
        <div class="y1">
      ...
      <div
        class="x1 pointer svip"
        v-push="'/recharge?key=svip'"
      >
        <div class="y1">
    ...
    <div class="l3 shadow page-padding">
      ...
      >
        <div
          class="x2 pointer"
          v-if="!option?.need_authorized || authorized"
          @click="option.do"
        >
          <img :src="option.icon">
          <p>{{ option.name }}</p>
